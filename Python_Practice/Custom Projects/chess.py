...
# Game Over Screen Function w/ Restart and Main Menu Options
...
#   The game starts with a menu allowing the player to choose between playing against an AI or playing against another player locally.
#   In AI mode, the Stockfish chess engine makes moves for the opponent.
#   In PvP mode, the board switches point of view between players after each move.
