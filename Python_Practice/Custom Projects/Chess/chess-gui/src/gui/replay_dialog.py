...
class ReplayDialog(QDialog):
    def __init__(self, moves, parent=None):
        ...
        self.menu_button = QPushButton("Return to Menu")  # Menu
    ...
    def update_move_list(self):
        ...
        try:
            ...
            print(f"Error in update_move_list: {e}")
    ...
    def previous_move(self):
        ...
        try:
            ...
            print(f"Error in previous_move: {e}")
            self.stop_play()
    ...
    def return_to_menu(self):
        ...
        self.stop_play()  # Stop any Ongoing Playback
